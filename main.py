...
# Set paths
orig_data_path = '/Users/mummy/Desktop/OS-027/orig_data/'
processing_path = '/Users/mummy/Desktop/OS-027/processing_s1/'

if flavor == 'vent':
    mat_path = orig_data_path + '/' + subject_id + '_' + scan_id + '_rad_' + flavor + '.mat' 
if flavor == 'gx':
    mat_path = orig_data_path + '/' + subject_id + '_' + scan_id + '.mat'
